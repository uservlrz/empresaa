...
layout = dbc.Container([
        ...
        dbc.Container([
            dbc.Row([
                dbc.Col([
                    html.H1("TOP", style={'color': '#184d5e','font-size': '60px',  'font-weight': 'bold'})
                ])
            ]),
            dbc.Row([
                dbc.Col([
                    html.H3("CONSTRUTORA", style={'color': 'white'})
                ]),
            ]),
        ...
        dbc.Row([
            dbc.Col([
                dbc.Nav([
                    dbc.NavItem(dbc.NavLink([html.I(className='fa fa-home dbc'), "\tINÍCIO"], href="/home", active=True, style={'text-align': 'left','margin-left': '15px', 'border-radius': '10px', })),
                    html.Br(),
                    dbc.NavItem(dbc.NavLink([html.I(className='fa fa-plus-circle dbc'), "\tATIVIDADES"], id='processo_button', active=True, style={'text-align': 'left','margin-left': '15px', 'border-radius': '10px'})),
                    html.Br(),
                    dbc.NavItem(dbc.NavLink([html.I(className='fa fa-user-plus dbc'), "\tESTÁGIARIOS"], id='lawyers_button', active=True, style={'text-align': 'left','margin-left': '15px', 'border-radius': '10px'})),
